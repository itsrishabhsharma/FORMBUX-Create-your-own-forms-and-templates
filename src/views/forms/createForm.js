...
class CreateForm extends Component {
    ...
    deleteItem(id){
      ...
      let activeIndex=forms.findIndex(x=>parseInt(x._id)===parseInt(this.props.state.formReducer.form._id));
      forms[activeIndex].fields.splice( forms[activeIndex].fields.findIndex(x=>x.id===id),1);
      APICall.post('forms/update',{
        formId:forms[activeIndex]._id,
        fields:forms[activeIndex].fields
    ...
    publishform(){
      ...
      APICall.post('forms/publish',{formId:this.props.state.formReducer.form._id,fields:this.state.fields},cookie.load('token')).then(res=>{
